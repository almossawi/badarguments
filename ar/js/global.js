(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/ar/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>أظهره ككتاب</a> <a href='/ar/?view=allpages' "
            + "id='view_all_pages'>أظهر كل الصفحات</a>";
        ...
        var e = "<a href='/ar/?view=flipbook' id='view_as_flipbook'>أظهره ككتاب</a> "
            + "<a href='/ar/?view=allpages' id='view_all_pages' "
            + "class='selected'>أظهر كل الصفحات</a>";
