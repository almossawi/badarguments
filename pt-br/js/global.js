(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/pt-br/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>Ver como livro</a> <a href='/pt-br/?view=allpages' "
            + "id='view_all_pages'>Ver todas as páginas</a>";
        ...
        var e = "<a href='/pt-br/?view=flipbook' id='view_as_flipbook'>Ver como libro</a> "
            + "<a href='/pt-br/?view=allpages' id='view_all_pages' "
            + "class='selected'>Ver todas as páginas</a>";
