(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/si/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>Poglej kot knjigo</a> <a href='/si/?view=allpages' "
            + "id='view_all_pages'>Poglej vse strani</a>";
        ...
        var e = "<a href='/si/?view=flipbook' id='view_as_flipbook'>Poglej kot knjigo</a> "
            + "<a href='/si/?view=allpages' id='view_all_pages' "
            + "class='selected'>Poglej vse strani</a>";
