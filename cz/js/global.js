(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/cz/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>Prohlédnout jako knihu</a> <a href='/cz/?view=allpages' "
            + "id='view_all_pages'>Prohlédnout všechny stránky</a>";
        ...
        var e = "<a href='/cz/?view=flipbook' id='view_as_flipbook'>Prohlédnout jako knihu</a> "
            + "<a href='/cz/?view=allpages' id='view_all_pages' "
            + "class='selected'>Prohlédnout všechny stránky</a>";
