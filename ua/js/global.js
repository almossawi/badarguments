(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/ua/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>Читати як книгу</a> <a href='/ua/?view=allpages' "
            + "id='view_all_pages'>Переглянути всі сторінки</a>";
        ...
        var e = "<a href='/ua/?view=flipbook' id='view_as_flipbook'>Читати як книгу</a> "
            + "<a href='/ua/?view=allpages' id='view_all_pages' "
            + "class='selected'>Переглянути всі сторінки</a>";
