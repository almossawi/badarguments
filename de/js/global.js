(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/de/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>Als Buch anzeigen</a> <a href='/de/?view=allpages' "
            + "id='view_all_pages'>Alle Seiten anzeigen</a>";
        ...
        var e = "<a href='/de/?view=flipbook' id='view_as_flipbook'>Als Buch anzeigen</a> "
            + "<a href='/de/?view=allpages' id='view_all_pages' "
            + "class='selected'>Alle Seiten anzeigen</a>";
