(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/es/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>Ver como libro</a> <a href='/es/?view=allpages' "
            + "id='view_all_pages'>Ver todas las páginas</a>";
        ...
        var e = "<a href='/es/?view=flipbook' id='view_as_flipbook'>Ver como libro</a> "
            + "<a href='/es/?view=allpages' id='view_all_pages' "
            + "class='selected'>Ver todas las páginas</a>";
