(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/he/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>צפייה כספר</a> <a href='/he/?view=allpages' "
            + "id='view_all_pages'>צפייה בכל העמודים</a>";
        ...
        var e = "<a href='/he/?view=flipbook' id='view_as_flipbook'>צפייה כספר</a> "
            + "<a href='/he/?view=allpages' id='view_all_pages' "
            + "class='selected'>צפייה בכל העמודים</a>";

        $("#zoom_info").html(e);$("#cover").attr("class","left");$("#blank_page").remove();$("div.right").css("border-left","1px solid #87827b").css("background-position","left top");$("img.right").css("border-left-color","#87827b");$(".right .page_number").css("right","83px");$("div.right, div.left").css("float","left").css("margin-bottom","15px");$("img.left, img.right").css("margin-bottom","15px");

        $.each($('.left'), function(i, d) {
            $(this)
