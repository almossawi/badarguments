(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/zh-cn/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>翻页模式</a> <a href='/zh-cn/?view=allpages' "
            + "id='view_all_pages'>平铺模式</a>";
        ...
        var e = "<a href='/zh-cn/?view=flipbook' id='view_as_flipbook'>翻页模式</a> "
            + "<a href='/zh-cn/?view=allpages' id='view_all_pages' "
            + "class='selected'>平铺模式</a>";
