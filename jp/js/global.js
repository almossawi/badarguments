(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/jp/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>本の形式で閲覧</a> <a href='/jp/?view=allpages' "
            + "id='view_all_pages'>全ページを閲覧</a>";
        ...
        var e = "<a href='/jp/?view=flipbook' id='view_as_flipbook'>本の形式で閲覧</a> "
            + "<a href='/jp/?view=allpages' id='view_all_pages' "
            + "class='selected'>全ページを閲覧</a>";
