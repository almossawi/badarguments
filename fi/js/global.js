(function() {
    ...
    if(getURLParameter('view') == undefined || getURLParameter('view') == 'flipbook') {
        ...
        var e = "<a href='/fi/?view=flipbook' id='view_as_flipbook' "
            + "class='selected'>Näytä kirjana</a> <a href='/fi/?view=allpages' "
            + "id='view_all_pages'>näytä kaikki sivuty</a>";
        ...
        var e = "<a href='/fi/?view=flipbook' id='view_as_flipbook'>Näytä kirjana</a> "
            + "<a href='/fi/?view=allpages' id='view_all_pages' "
            + "class='selected'>näytä kaikki sivut</a>";
